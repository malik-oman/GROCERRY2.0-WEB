...
const WishList = () => {
   ...
   const {favorite, currency, removeFavorite,addToCart } = useContext(AppContext)
             ...
             <div className='grid grid-cols-3 items-center mb-4'>
                ...
                <p>{currency}{item.offerPrice}</p>
                 ...
                 <div className='flex items-center gap-5'>
                    <p onClick={()=>removeFavorite(item._id)} className='text-red-500 cursor-pointer hover:underline'><CircleX/></p>
                    <p onClick={()=>addToCart(item)} className='text-green-500 cursor-pointer hover:underline'><BadgePlus/></p>
                  </div> 
