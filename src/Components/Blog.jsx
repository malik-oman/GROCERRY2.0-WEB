    ...
    <div className='py-12'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center justify-center'>
        {blogsData.map((item,index)=>(
          <div key={index}>
           <motion.div whileHover={{scale: 1.1}} transition={{ease: "easeInOut",duration: 0.5}}>
           ...
           <div className='flex items-center my-4'>
            ...
            <button className='bg-secondary text-white px-6 py-2 cursor-pointer mt-5'>Read More</button>
           </div>
